...
## 1. Myth vs. Fact (`talira_myth_vs_fact_*.png`)
...
## 2. Hiring Flip (`talira_hiring_flip_*.png`)
...
✅ Never calls in sick
✅ Never takes lunch
✅ Answers every call in under a second
...
## 3. Missed Call (`talira_missed_call_*.png`)

**Caption:**
It's 9:47 PM. Your phone is ringing.
...
## 4. Big Stat (`talira_big_stat_*.png`)
...
Now do the math: 10 missed calls a week × your average job value. That's what voicemail costs you every single month.

Talira answers 24/7, responds in <500ms, and books 3x more leads. The demo takes 5 minutes and costs nothing: taliravoice.com

---

## 5. Maze (`talira_maze_*.png`)
...
We build it for you. Talira → taliravoice.com

---

## 6. 24/7 Receptionist (`talira_247_receptionist_*.png`)

**Caption:**
She never sleeps. Never takes lunch. Never loses a lead.

Your Talira receptionist answers every call in under a second, books appointments into your calendar, follows up in your CRM, and hands off to a human whenever it matters.
...
**Headlines (mix & match, ≤30 chars):**
- 24/7 AI Receptionist
- Never Miss a Call Again
- AI Answering For Your Business
- Every Call Answered In <1s
- Books Appointments 24/7
- 80% Cheaper Than Hiring
- Free 5-Minute Live Demo
- Done-For-You Setup

**Descriptions (≤90 chars):**
- 85% of voicemail callers never call back. Talira answers 24/7 and books the appointment.
- We build, train & install your AI receptionist. Calendar + CRM included. Hear it live.
- Human-like AI voice agents for small business. Free 5-min live demo call.

## Cold email opener (vertical-swappable)
